...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String [] permissions={Manifest.permission_group.PHONE,Manifest.permission_group.STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE};
        boolean b = checkPermissions(permissions);
        Log.i(TAG, "onCreate: "+b);
        List<String> deniedPermissions = getDeniedPermissions(permissions);
        Log.i(TAG, "onCreate: "+deniedPermissions);
